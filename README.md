...
[![CI Molecule](https://github.com/darexsu/ansible-role-php/actions/workflows/ci.yml/badge.svg)](https://github.com/darexsu/ansible-role-php/actions/workflows/ci.yml)&emsp;![](https://img.shields.io/static/v1?label=idempotence&message=ok&color=success)&emsp;![Ansible Role](https://img.shields.io/ansible/role/d/57603?color=blue&label=downloads)
  ...
  - Playbooks (merge version):
      - [install and configure: PHP v7.4](#install-and-configure-php-merge-version)
          - [install: PHP v7.4, repository: distribution](#install-php-repository-distribution-merge-version)
          - [install: PHP v8.0, repository: third_party](#install-php-repository-third_party-merge-version)
  ...
  - Playbooks (full version):
      - [install and configure: PHP v7.4](#install-and-configure-php-full-version)
          - [install: PHP v7.4, repository: distribution](#install-php-repository-distribution-full-version)
          - [install: PHP v8.0, repository: third_party](#install-php-repository-third_party-full-version)
